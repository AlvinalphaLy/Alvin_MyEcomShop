...
const Contact = () => {
    return(
        <div
            ...
            style={{backgroundImage: "url('https://images.pexels.com/photos/2116721/pexels-photo-2116721.jpeg?_gl=1*gzgpff*_ga*MjAyODk4NzIxNC4xNzU0NDI2ODAw*_ga_8JE65Q40S6*czE3NTQ0NDk2MTIkbzMkZzEkdDE3NTQ0NTA0NTgkajE4JGwwJGgw')"}}>
                ...
                <div className="mt-8 text-center">
                    ...
                    <div className="flex flex-col items-center space-y-2 mt-4">
                        ...
                        <div className="flex items-center">
                            ...
                            <span className="text-gray-600">kclynguyenkhanh@gmail.com</span>
                        </div>
