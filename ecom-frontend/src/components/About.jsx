           ...
           <div className="flex flex-col lg:flex-row justify-between items-center mb-12">
                <div className="w-full md:w-1/2 text-center md:text-left">
                    <p className="text-lg mb-4">
                        ...
                        We're committed to delivering top-quality products 
                        and exceptional service. Our goal is to provide you 
                        with a smooth and enjoyable shopping experience 
                        while maintaining the highest standards 
                        in everything we offer. Note: This is Alvin's project,
                ...
                <div className="w-full md:w-1/2 mb-6 md:mb-0">
                    <img
                        src="https://images.pexels.com/photos/699122/pexels-photo-699122.jpeg?_gl=1*1tagixn*_ga*MjAyODk4NzIxNC4xNzU0NDI2ODAw*_ga_8JE65Q40S6*czE3NTQ0NDk2MTIkbzMkZzEkdDE3NTQ0NDk5OTMkajU3JGwwJGgw"
                        alt="About Us"
